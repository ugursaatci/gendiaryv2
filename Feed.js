...
class Feed extends Component {
  ...
  checkUserAuthentication = async () => {
    try {
      ...
      if (userToken) {
        // Token var, kullanıcı doğrulandı
        // Şimdi bu tokeni kullanarak istekler yapabilirsiniz
        // Örneğin:
        // fetch('http://your-backend-url/data', {
        //   headers: {
        ...
        // Token bulunamadı, kullanıcı doğrulanamadı veya oturum sona erdi
  ...
  render() {
    handleClick = (e) => {
      ...
      fetch("http://192.168.1.79:8089/post", {
        method: "POST",
