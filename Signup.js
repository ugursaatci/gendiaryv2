...
export default class Signup extends Component {
  ...
  handleClick = (e) => {
    ...
    {
      console.log(user);
      fetch("http://192.168.1.79:8089/auth/registration", {
      method: "POST",
    ...
    .catch(error => {
      ...
      Alert.alert('Password Does Not Match!', 'Password Does Not Match!');
    }
      ...
      <View style={style.container}>
        ...
        <View>
          ...
          <View style={{ flex: 30, flexdirection: "column" }}>
            ...
            <TextInput style={style.text_box} value={this.state.country} onChangeText={(country) => this.setCountry(country)} placeholder="Country" placeholderTextColor='#effaf6' />
